...
public class ContactsListView extends Composite implements ContactsListActivity.Displayable {
    ...
    @UiHandler("addRandom")
    public void handleAddRandom(ClickEvent e) {
    }
    ...
    public class ImapLabelListDataProvider extends AsyncDataProvider<LabelNode> implements HasRefreshed {
    ...
    @Override
    public HasClickHandlers getAddRandom() {
        return addRandom;
    }
