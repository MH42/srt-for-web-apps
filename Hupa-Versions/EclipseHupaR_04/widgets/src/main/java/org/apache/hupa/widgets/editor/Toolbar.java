 ...
 * functionality.
 */
public class Toolbar extends Composite { // XXX modified from Hupa repository revision 911155 (complete class replaced): Renamed formatter to basic and extended
	...
	public Toolbar(RichTextArea richText, ToolbarConstants strings) {
        ...
        this.basic = richText.getBasicFormatter();			// XXX modified Renamed formatter to basic and extended
        this.extended = richText.getExtendedFormatter();	// XXX modified Renamed formatter to basic and extended
